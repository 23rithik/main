...
const Wsubmitform5 = () => {
    const [form, setForm] = useState({
        week_name: 'Week 5', // Updated value for Week 5
                ...
                <Grid item xs={12} md={10} lg={8}>
                    <TableContainer component={Paper} style={{ marginBottom: "20px" }}>
                        <Typography variant="h6" style={{ padding: "10px" }}>
                            <b>Submission Form for Week 5</b>
                        </Typography>
                        <Table sx={{ minWidth: 650 }} aria-label="submission week 5 table">
                            <TableBody>
                                <TableRow>
